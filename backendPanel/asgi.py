...
if not settings.configured:
    ...
    settings.configure(
        ...
        JWT_SECRET_KEY=_app_settings.jwt_secret_key,
        JWT_ALGORITHM=_app_settings.jwt_algorithm,
        JWT_ACCESS_TOKEN_EXPIRE_SECONDS=_app_settings.jwt_access_token_expire_seconds,
