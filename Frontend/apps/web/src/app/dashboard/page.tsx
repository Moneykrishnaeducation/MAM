...
export default function Dashboard() {
  ...
  useEffect(() => {
    setIsLoaded(true);
    document.title = "MAM Dashboard | Money Krishna Education";
  }, []);
  ...
  return (
    <div className={`p-8 z-10 transition-all duration-700 ease-out relative ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-5'}`}>
